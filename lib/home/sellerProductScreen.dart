...
class SellerProductScreen extends StatefulWidget{
  dynamic data;
  SellerProductScreen({super.key, required this.data});
  @override
  State<StatefulWidget> createState() => _sellerProductScreen(data: data);

}

class _sellerProductScreen extends State<SellerProductScreen> {
  @override
  void initState() {
  ...
  dynamic data;
  _sellerProductScreen({required this.data});
  @override
  Widget build(BuildContext context) {
    ...
    return bgWidget(child: Scaffold(
        ...
        body: FutureBuilder(
            future: FirebaseServices.GetVendorProduct(data["user_id"]),
